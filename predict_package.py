...
for image_path in glob.glob(f'/root/Work/dataset/Retinogram(L)/*jpg'):
      results = model.predict(source=image_path,project="/root/Work/yolov8/object_detection/",name="retina(L)",save=True)
      print("\n")